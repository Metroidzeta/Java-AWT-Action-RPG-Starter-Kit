![Java/AWT-Action-RPG-Starter-Kit-screen-1](https://raw.githubusercontent.com/Metroidzeta/Java-AWT-Action-RPG-Starter-Kit/refs/heads/main/screenshots/Java-AWT-Action-RPG-Starter-Kit-screen-1.png)
![Java/AWT-Action-RPG-Starter-Kit-screen-2](https://raw.githubusercontent.com/Metroidzeta/Java-AWT-Action-RPG-Starter-Kit/refs/heads/main/screenshots/Java-AWT-Action-RPG-Starter-Kit-screen-2.png)
...
Depuis la racine du projet, exécuter la commande avec le terminal ```java -cp "bin;libs/*" core.Main```
...
👉 Voir le fichier complet [LICENSE.md](https://github.com/Metroidzeta/Java-AWT-Action-RPG-Starter-Kit/blob/main/LICENSE.md) pour les termes détaillés (versions française et anglaise).
...
From the project root folder, run the command with the terminal ```java -cp "bin;libs/*" core.Main``` file.
...
👉 See the full [LICENSE.md](https://github.com/Metroidzeta/Java-AWT-Action-RPG-Starter-Kit/blob/main/LICENSE.md) file for detailed terms in both French and English.
